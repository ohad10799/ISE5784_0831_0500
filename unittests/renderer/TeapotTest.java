...
public class TeapotTest {
    ...
    double distance = 1000; // Distance from the origin
    Point baseLocation = new Point(0, 0, -1000);
    Vector baseDirection = new Vector(0, 0, 1);
    Vector baseUp = new Vector(0, 1, 0);
    ...
    public void teapot() {
        ...
        camera1.renderImage().printGrid(50, new Color(YELLOW)).writeToImage();
    }
